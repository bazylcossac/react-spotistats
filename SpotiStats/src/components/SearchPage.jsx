...
const SearchPage = () => {  
    ...
    if(!data){
     ...
     return (
        <div>
        <span className='flex flex-row text-[#525252] font-bold p-4'>Results for:<p className='text-white ml-2'>{searchParams.get('artist').slice(1)}</p> </span>
         ...
         <div className='px-4 py-4 flex flex-row items-center text-center'>
            <Link to={`/${firstArtist.id}`}>
                    <div className='bg-[#272727] py-6 px-4 inline-block rounded-lg text-center shadow-lg'>
                        <img src={firstArtist.images[0].url} className='rounded-full size-32' />
