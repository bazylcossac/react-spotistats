...
function FirstArtist({firstArtist}) {
  return (
    <div className="px-4 py-4 flex flex-row items-center text-center">
        ...
        <div className="flex flex-col justify-between">
          <span className="ml-4 space-x-2 flex flex-row ">
            {firstArtist?.genres.slice(0, 1).map((genre) => (
              <div
                key={genre}
          ...
          <div className="bg-[#272727] text-center ml-4 mt-4 py-2 rounded-lg shadow-lg">
            <p className="someWhite font-bold">
              {firstArtist?.type.toUpperCase() || "None"}
            </p>
          </div>
          ...
          <Link to={firstArtist?.uri ? firstArtist?.uri : "/"}>
            <div className="bg-[#272727] ml-4 mt-4 flex justify-center rounded-lg shadow-lg">
              ...
              >
                ...
                />
                <g
                  transform="matrix(.21375 0 0 .21375 .138028 12.655604)"
                  fill="#1ed760"
                >
